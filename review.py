...
RestaurantPage = urllib.request.urlopen("https://www.yelp.com/biz/lou-malnatis-pizzeria-chicago-9?sort_by=date_asc").read()
...
for a in Reviews:
    ...
    print(reviewerID + " " + reviewID + " " + date + " " + rating)
